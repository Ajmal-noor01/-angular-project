...
import { matchGuardGuard } from './guards/match-guard.guard';
...
export const routes: Routes = [
    ...
    { path: "product-details", loadComponent: () => import('./product-details/product-details.component').then(c => c.ProductDetailsComponent), canMatch: [matchGuardGuard] },
